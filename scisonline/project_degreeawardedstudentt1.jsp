<%-- 
    Document   : project_degreeawardedstudentt1
    Created on : 24 Feb, 2015, 12:32:16 PM
    Author     : deep
--%>
...
<html>
        ...
        <script type="text/javascript" >
            $(document).ready(function($) {
                ...
                $('#year').change(function(){
                    ...
                    var year = $(this).val();
                    window.document.forms["forrm"].action = "project_degreeawardedstudentlist.jsp?pgname=" + programme + "&year=" + year;
    ...
    <body>
        <form  id="frmm" name="forrm" method="POST" target="act_area4" >
            <center>
            <table>
                <tr>
