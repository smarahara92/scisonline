<%-- 
    Document   : PhD_reregisteredstudent
    Created on : 30 Apr, 2015, 11:33:45 AM
    Author     : deep
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            try {
                ...
                while (rs1.next()) {
                    ...
                    System.out.println("batch year is " +batchYear);
                    ResultSet rs_sname=st_snam.executeQuery("select StudentId from  PhD_"+batchYear+" where StudentId='"+rs1.getString(1)+"'"+ "and status = 'RR'");
        ...
        %>          <table align="center" border="1">
                        <tr  bgcolor="#c2000d">
                            <td align="center" class="style31"><font size="4">List of re-registered students</font></td>
                        </tr>
                    </table>
                    <br>
        ...
        <%               flag = 1;
                          ...
                          if(rs_sname.next() && rs3.next()) { 
        %>
                        <tr>
                            <td> <%=rs_sname.getString("StudentId")%></td>
    ...
    <%if (flag == 0) {%>
            <tr><td colspan=2> <h3 style="color:#c2000d" align="center">No re-registered student available</h3></td></tr>
    <%  }%>
