<%-- 
    Document   : fullrecordview
    Created on : 4 May, 2014, 4:25:13 PM
    Author     : srinu
--%>
            ...
            <%
                ...
                if (sid.equals("none")) {
                    ...
                    try {
                       ...
                       rs1 = st1.executeQuery("select * from PhD_" + BATCH_YEAR + " where StudentId='" + sid + "'");
                        }
                        else{
                        rs1=st1.executeQuery("select * from PhD_"+BATCH_YEAR+" where StudentId='" + sid + "' AND ( supervisor1='"+user+"' or supervisor2='"+user+"' or supervisor3='"+user+"' )");
            ...
            <center>
                ...
                <table border="10" cellspacing="5" cellpadding="5" style="color:blue;background-color:#CCFFFF;" align="center">
                    ...
                    <tr>
                        ...
                        <td> <a target= "_self" href="drcview3.jsp?studentid=<%=sid%>&date=<%=rs3.getString("date" + d)%>"><%=rs3.getString("date" + d)%></a></td>
