<%-- 
    Document   : PhD_extensionstudent
    Created on : 27 Apr, 2015, 4:10:12 PM
    Author     : deep
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            try {
                ...
                while (rs1.next()) {
                    ...
                    ResultSet rs_sname=st_snam.executeQuery("select StudentId from  PhD_"+batchYear+" where StudentId='"+rs1.getString(1)+"'"+ "and status = 'ER'");
        ...
        %>          <table align="center" border="1">
                        <tr  bgcolor="#c2000d">
                            <td align="center" class="style31"><font size="4">List of students who are on extension</font></td>
                        </tr>
                    </table>
                    <br>
    ...
    <%if (flag == 0) {%>
            <tr><td colspan=2> <h3 style="color:#c2000d" align="center">No extension  student available</h3></td></tr>
    <%  }%>
