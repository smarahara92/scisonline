<%-- 
    Document   : supplementaryview2
    Created on : Apr 3, 2014, 2:59:42 PM
    Author     : veeru
--%>
...
<html>
    ...
    <body>
        ...
        <form name="form1" id="form1" action="supplementaryview4.jsp" target="act_area" onsubmit="return fun1();" method="POST">
            <table>
