...
// removed this part 20-1-14 below
        /*    if (given_session.equals("Winter")) {
            ...
            ResultSet rs = (ResultSet) st3.executeQuery("select Electives, Cores from " + currrefer_s + " where Semester = '" + sem + "'");
            if (rs.next()) {
    ...
    <body bgcolor="#CCFFFF"  onload="dothis(1,1)">
        ...
        <form action="choose_ele_new_stored_before2014.jsp" name="ele_form" id="ele_form">
