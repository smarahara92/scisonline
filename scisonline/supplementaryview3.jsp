<%-- 
    Document   : supplementaryview3
    Created on : Apr 3, 2014, 3:24:46 PM
    Author     : veeru
--%>
...
<html>
        ...
        <script>
            function fun1() {
                if (document.getElementById("mySelect1").value === "Select Subject")
                {
                    ...
                    window.document.forms["form1"].action = "supplementaryview3link.jsp";
                    document.forms.form1.submit();
                }
            }
    ...
    <body>
        <form name="form1" target="act_area" method="POST">
            ...
            %>   <select align="left" valign="bottom" style="width:175px" name="subjectId" id="mySelect1" onchange="fun1();"> 
