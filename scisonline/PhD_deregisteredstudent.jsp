<%-- 
    Document   : PhD_deregisteredstudent
    Created on : 27 Apr, 2015, 4:32:55 PM
    Author     : deep
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            try {
                ...
                while (rs1.next()) {
                    ...
                    ResultSet rs_sname=st_snam.executeQuery("select StudentId from  PhD_"+batchYear+" where StudentId='"+rs1.getString(1)+"'"+ "and status = 'DR'");
        ...
        %>          <table align="center" border="1">
                        <tr  bgcolor="#c2000d">
                            <td align="center" class="style31"><font size="4">List of de-registered students</font></td>
                        </tr>
                    </table>
                    <br>
    ...
    <%if (flag == 0) {%>
            <tr><td colspan=2> <h3 style="color:#c2000d" align="center">No de-registered student available</h3></td></tr>
    <%  }%>
