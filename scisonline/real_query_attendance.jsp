...
<html>
        ...
        <script> 
            ...
            $(document).ready(function() {
                ...
                $('.prgBatch0').change(function(){
                    ...
                    var pyear = $('#year0').val();
                    alert(pname+pyear);
                    $('#target10').load("Demo.jsp?pname="+pname+"&pyear="+pyear);
                });
                $('.prgBatch1').change(function(){
                    var pname = $('#pgname1').val();
                    var pyear = $('#year1').val();
                    alert(pname+pyear);
                    $('#target11').load("Q_Subjectwise_AttenFINAL_15.jsp?pname="+pname+"&pyear="+pyear);
                });
    ...
    <body>
        ...
        <div id = "q0" class = "trigger x ui-btn ui-icon-plus ui-btn-icon-left">List of students who have less than 75% attendance in a particular stream and batch </div>
        <div class = "toggle" id="sq0">
           
        </div>
        <div id = "q1" class = "trigger x ui-btn ui-icon-plus ui-btn-icon-left">List of students who have less than 75% attendance in a particular subject </div>
