<%-- 
    Document   : project_panelmarksstudent1
    Created on : 21 Feb, 2015, 11:06:41 AM
    Author     : deep
--%>
...
<html>
        ...
        <script type="text/javascript" >
            $(document).ready(function($) {
                ...
                $('#year').change(function(){
                    ...
                    var year = $(this).val();
                    window.document.forms["forrm"].action = "project_panelmarksstudentlist.jsp?pgname=" + programme + "&year=" + year;
    ...
    <body>
        <form  id="frmm" name="forrm" method="POST" target="act_area1" >
            <center>
            <table>
                <tr>
