<%-- 
    Document   : listofstudents_supp
    Created on : May 27, 2013, 11:33:04 PM
    Author     : root
--%>
...
<html>
    ...
    suptable="supp_"+semester+"_"+cyear;
 ...
 try
   ...
   %>
      <center>
        ...
        <center><b>List of students registered for supplementary</b></center> 
         </br>
        ...
        <tr>
            ...
            <th>Student ID</th>
            <th colspan="7">Registered subjects</th>
          </tr>       
       <%
         while(rs1.next())
         {
