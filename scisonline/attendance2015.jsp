<%-- 
    Document   : attendance2015.jsp
    Created on : Jan 22, 2015, 10:16:58 AM
    Author     : richa
--%>
        ...
        <form action="GetParameterMethod.jsp" name="frm" method="post"  onsubmit="return textcheck();"> 
            ...
            <table  border="1" align="center" class="table">
                ...
                <TR>
                    ...
                    <TD class="td"><%=rs.getString(2)%></TD>
                        <%if (rs.getString(8) == null) {%>
                    <td class="td"> <input type="text" name="marks1" id="<%=Integer.toString(i)%>" value="0" onKeyPress ="return disableEnterKey(event)"  onchange="ValidateValues2(<%=Integer.toString(i)%>);"  ></td>
                    <%} else {%>
                    <TD class="td"> <input type="text" name="marks1" id="<%=Integer.toString(i)%>" value="<%=rs.getString(8)%>" onKeyPress ="return disableEnterKey(event)" onchange="ValidateValues2(<%=Integer.toString(i)%>);"  ></TD>
                        <%}
                            if (rs.getString(6) != null) {
                        %>
                    <TD class="td"><input type="text" name="marks" id="<%=Integer.toString(i)%>" value="<%=rs.getString(6)%>" onKeyPress ="return disableEnterKey(event)"  onchange="ValidateValues1(<%=Integer.toString(i)%>);"  ></TD>
