<%-- 
    Document   : project_supervisormajormarksstudent1
    Created on : 3 Mar, 2015, 2:40:32 PM
    Author     : deep
--%>
        ...
        <script type="text/javascript" >
            $(document).ready(function($) {
                ...
                $('#year').change(function(){
                    ...
                    var year = $(this).val();
                    window.document.forms["forrm"].action = "project_supervisormajormarksstudentlist.jsp?pgname=" + programme + "&year=" + year;
