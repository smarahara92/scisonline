<%-- 
    Document   : facultysummary1
    Created on : 15 May, 2015, 12:00:23 PM
    Author     : nwlab
--%>
        ...
        <script type="text/javascript">
            ...
            function link1()
            {
                ...
                if (pname === "-Programme-")
                {
                    ...
                    parent.act_area.location = "./projectFacultySummary.jsp?pgname=" + pname;
            ...
            $(document).ready(function($) {
                $("#pg").change(function() {
                        ...
                        if(programme !== ""){
                            ...
                            $('#year').html("<option value=\"\">Select year of joining</option>");
                        }
                        //*/
                  //  }
                });
                $('#year').change(function(){
                    ...
                    var year = $(this).val();
                    window.document.forms["form"].action = "projectFacultySummary.jsp?pgname=" + programme + "&year=" + year;
