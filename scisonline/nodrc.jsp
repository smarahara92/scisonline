<%-- 
    Document   : nodrc
    Created on : 27 May, 2014, 6:42:56 PM
    Author     : srinu
--%>
...
<html>
        ...
        <%
            ...
            try {
                ...
                while (rs1.next()) {
                    ...
                    rs_sname.next();
                    if (rs1.getString("drc1") == null && rs1.getString("drc2") == null) {
        %>          <table align="center" border="1">
                        <tr  bgcolor="#c2000d">
                            <td align="center" class="style31"><font size="4">Students With No DRC</font></td>
                        </tr>
                    </table>
                    <br>
    ...
    <%if (flag == 0) {%>
            <tr><td colspan=2> <h3 style="color:#c2000d" align="center">No student available to whom DRC is not allocated</h3></td></tr>
    <%  }%>
