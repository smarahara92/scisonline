<%-- 
    Document   : projectFacultyAssessementExt
...
<html>
    ...
    <body bgcolor="E0FFFF">
        ...
        <form  id="form" method="POST" onsubmit="" action="projectFacultyAssessmentExt1.jsp" >
            ...
            <table align="center" >
                <caption>
                    <h2 class="style11"><%=pgname%> Project Final Marks</h2>
                </caption>
                <tr>
                    <th>Student ID </th>
                    <th>Student Name </th>
                ...
                <%
                    ...
                    pst = con.prepareStatement("create table if not exists " + table + "(ProjectId int(5) NOT NULL AUTO_INCREMENT,ProjectTitle varchar(200),SupervisorId1 varchar(20),SupervisorId2 varchar(20),SupervisorId3 varchar(20),Organization varchar(30),Allocated varchar(10),primary key(ProjectId))");
                    pst.executeUpdate();
                    // st6.executeUpdate("create table if not exists " + table + "(ProjectId int(5) NOT NULL AUTO_INCREMENT,ProjectTitle varchar(200),SupervisorId1 varchar(20),SupervisorId2 varchar(20),SupervisorId3 varchar(20),Organization varchar(30),Allocated varchar(10),primary key(ProjectId))");
                    try {
...
//                        pst = con.prepareStatement("select Programme_name from programme_table where Programme_group=?");
//                        pst.setString(1, pgname.replace('-', '_'));
                        ...
                        while (rs1.next()) {
                            ...
                            while (rs2.next()) {
                                ...
                                while (rs3.next()) {
                                    ...
                                    //
//                                    table2 = rs2.getString(1).replace('-', '_') + "_" + streamYear;
//
//                                    pst = con.prepareStatement("select StudentName from " + table2 + " where StudentId=?");
//                                    pst.setString(1, studId);
//                                    rs4 = pst.executeQuery();

                                    pst = con.prepareStatement("select AdvisorMarks2 from " + table1 + " where StudentId=?");
                                    pst.setString(1, studId);
