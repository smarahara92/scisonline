<%-- 
    Document   : project_supervisormarksstudent1
    Created on : 23 Feb, 2015, 11:11:54 AM
    Author     : deep
--%>
...
<html>
        ...
        <script type="text/javascript" >
            $(document).ready(function($) {
                ...
                $('#year').change(function(){
                    ...
                    var year = $(this).val();
                    window.document.forms["forrm"].action = "project_supervisormarksstudentlist.jsp?pgname=" + programme + "&year=" + year;
    ...
    <body>
        <form  id="frmm" name="forrm" method="POST" target="act_area2" >
             <center>
            <table>
                <tr>
