<%-- 
    ...
    Created on : Nov 17, 2013, 2:00:46 PM
    Author     : sri
--%>
    ...
    <form action="choose_ele_new_stored.jsp" name="ele_form" id="ele_form">
        ...
        <table align="center" border="1"><!-- class="table_pos"-->
            ...
            <%
                ...
                int k = 1;
                ResultSet rs = (ResultSet) ConnectionDemo.getStatementObj().executeQuery("select * from " + stream_table + " where StudentId='" + selected_id + "'");
                while (rs.next()) {
