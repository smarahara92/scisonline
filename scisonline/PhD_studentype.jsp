<%-- 
    Document   : PhD_studentype
    Created on : 30 Apr, 2015, 12:28:20 PM
    Author     : deep
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            try {
                ...
                while (rs1.next()) {
                    ...
                    ResultSet rs_sname=st_snam.executeQuery("select StudentId, ft_pt_ex from  PhD_"+batchYear+" where StudentId='"+rs1.getString(1)+"'");
        ...
        %>          <table align="center" border="1">
                        <tr  bgcolor="#c2000d">
                            <td align="center" class="style31"><font size="4">Registration type of PhD students </font></td>
                        </tr>
                    </table>
                    <br>
        ...
        %>
                        <tr>
                            ...
                            <%if(rs_sname.getString(2).equalsIgnoreCase("EX")) {%>
                                <td> External </td>
                        <%    } else if(rs_sname.getString(2).equalsIgnoreCase("FT")) {  %>
                                 <td> Full time </td>
                        <%    } else { %>
                                 <td> Part time </td>
                         <%   }%>
