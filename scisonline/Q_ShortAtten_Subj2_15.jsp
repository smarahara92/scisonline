<%-- 
    Document   : Q_ShortAtten_Subj2_15
    Created on : Mar 18, 2015, 11:52:47 AM
    Author     : richa
--%>
...
<html>
        ...
        <script>
            ...
            function loadXMLDoc()
            {
                ...
                if (document.getElementById('mySelect1').value === "Select Programme") {
                    ...
                    parent.staffaction.location = "./BalankPage2.jsp";
                    document.getElementById('errfn').innerHTML = "*Select Year";
    ...
    <body onload="fun1();">
        ...
        %>  
        <form name="form1" id="form1" action="Demo_streamsummary.jsp" target="staffaction" method="POST">
