...
<html>
        ...
        <script language="javascript">
            function display1()
            {
                ...
                if (document.getElementById("mySelect1").value === "Select Subject")
                {
                    ...
                    window.document.forms["form1"].action = "subjsummary_1.jsp";
                    document.forms.form1.submit();
                }
    ...
    <body>
        ...
        <%
            ...
            if (x == 0) {
        %>
        <form name="form1" action="subjsummary_1.jsp" target="facultyaction" method="POST">
            ...
            <select align="left" valign="bottom" style="display:none;" name="subjectid" id="mySelect2" onchange="display();"> 
                <option>Select Subject</option>
                <%  while (rs1.next()) {
