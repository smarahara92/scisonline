<%-- 
    Document   : project_degreenotawardedstudentt1
    Created on : 24 Feb, 2015, 1:01:20 PM
    Author     : deep
--%>
        ...
        <script type="text/javascript" >
            $(document).ready(function($) {
                ...
                $('#year').change(function(){
                    ...
                    var year = $(this).val();
                    window.document.forms["forrm"].action = "project_degreenotawardedstudentlist.jsp?pgname=" + programme + "&year=" + year;
