...
<html>
    ...
    <body bgcolor="#CCFFFF">
        ...
        //    if(latestYear  < 2014)
          //  { %> 
            <%--<jsp:forward page="choose_ele_modify_1_before2014.jsp"/>
            --%>
            <% 
           // }
            /*
            ...
            Statement st_study1 = (Statement) con.createStatement();
            ...
            int electives = 0,optionalCore_count=0;
            //System.out.println("laxman"+total_stu);
            ResultSet rs_t = (ResultSet) st3.executeQuery("select Electives, Cores,OptionalCore from " + currrefer_s + " where Semester = '" + sem + "'");
            if (rs_t.next()) {
                current_cores = rs_t.getInt(2); // current cores
                 electives = rs_t.getInt(1);  
                 optionalCore_count = rs_t.getInt(3);
                 course_count = electives+optionalCore_count;/// # electives for given stream
        ...
        <form action="choose_ele_modify_stored.jsp" name="frm1" id="frm1">
            ...
            <table align="center" border="1"><!-- class="table_pos"-->
                ...
                <tr>
                    ...
                    <% int i;
                        ...
                        for (i = 1; i <= optionalCore_count; i++) {
                          int  len = 150;
                    %> 
                    ...
                    <td>
                        <select name="select<%=Integer.toString(i)%>" id="select<%=Integer.toString(i)%>" onchange="dothis(<%=Integer.toString(i)%>);" style="width:<%=len%>px;">
                            ...
                            if( temp1 <  i)
                            {
                              ...
                              rs_old_ele = (ResultSet) st4_old_ele1.executeQuery("select ele" + ele_start_live + " from " + stream_table + "  where StudentId='" + selected_id + "'"); 
                                ele_start_live = ele_start_live + 1;
                             
                            }
                            else
                            {
                               rs_old_ele = (ResultSet) st4_old_ele.executeQuery("select optCore" + optionalCore_start_live + " from " + stream_table + "  where StudentId='" + selected_id + "'");
                            // temp1 = temp1 +1;
                               optionalCore_start_live = optionalCore_start_live+1;
                                ...
                                if (old_ele_flag == 1) {
                                    ...
                                    ResultSet rs_old_ele2 = st.executeQuery("select Subject_Name  from subjecttable where Code='" + old_ele + "'");
                                    if (rs_old_ele2.next()) {
                            ...
                            <% }
                               ...
                               int temp = optionalCore_count;
                                ...
                                while (rs3.next()) {
                                    ...
                                    {
                                        ResultSet rs_check_study1 = (ResultSet) st_study1.executeQuery("select * from " + stream_table + " where StudentId='" + selected_id + "' and (" +check_optCore + ")");
                ...
                <input type="hidden" name="course_count" value="<%=course_count%>">
                 <input type="hidden" name="optionalCore_count" value="<%=optionalCore_count%>">
