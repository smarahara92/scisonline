<%-- 
Document   : supplementaryview4
Created on : Apr 3, 2014, 4:14:25 PM
Author     : veeru
--%>
...
<html>
    ...
    <body onload="fun();">
        ...
        <table align="center">
            <th>Student ID</th>
            <th>Student Name</th>
            <th>Total Supplementary Subjects</th>
            <tr>
        ...
        <table align="center" border="1" class="table">
            <caption><h2>Supplementary Subjects</h2></caption>
            ...
            <%
                ...
                for (j = 0; j < sem1; j++) {
                    ...
                    if (j == 0) {
                        try {
                            rs5 = st4.executeQuery("select * from supp_Monsoon_" + batchYear1 + " where studentId='" + studentId + "'");
                            if (rs5.next()) {
            ...
            <%
                ...
                try {
                    ...
                    rs5 = st4.executeQuery("select * from supp_Winter_" + batchYear1 + " where studentId='" + studentId + "'");
                    if (rs5.next()) {
                        System.out.println("\\\\\\");
            ...
            <tr>
                ...
                <%
                    ...
                    rs7 = st6.executeQuery("select TotalMarks from " + rs5.getString(colNum) + "_Assessment_Winter_" + batchYear1 + " where StudentId='" + studentId + "'");
