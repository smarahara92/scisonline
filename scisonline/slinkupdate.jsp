<%-- 
    Document   : slinkupdate
    Created on : Feb 24, 2012, 6:29:58 PM
    Author     : jagan
--%>
    ...
    <body onload="fun1();">
        <%
            ...
            try {
                ...
                String qry2 = "select Code, Subject_Name from subjecttable as a, subject_faculty_" + semester + "_" + year + " as b where a.Code=b.subjectid;";
        ...
        <%
            ...
            if (x == 0) {
        %>
        <form name="form1" action="choose.jsp" target="staffaction" method="POST">
            ...
            <select align="left" valign="bottom"  name="subjectid" id="mySelect2" style="display: none"> 
                <option>Select Subject</option>
                <%  while (rs1.next()) {
